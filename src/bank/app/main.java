...
public static void main(String[] args){
    ...
    try {acc1.withdraw(new BigDecimal(15000.0));} catch (IllegalArgumentException e) {
        System.out.println("operation error");
    }
    acc2.deposit(new BigDecimal(1000.0));
    cus.accountsInfo();
    ...
    acc1.deposit(new BigDecimal(133.0));
    acc2.withdraw(new BigDecimal(23000.0));
    acc2.close();
    cus.accountsInfo();
